...
// $Id: w700_fe.java,v 1.36 2012/01/29 15:46:12 drmiller Exp $
import java.awt.*;
...
class _Key {
	final String ident = "$Id: w700_fe.java,v 1.36 2012/01/29 15:46:12 drmiller Exp $";
	...
	implements ActionListener, WindowListener, ComponentListener, HyperlinkListener
{
	...
	public void showAbout() {
		JLabel lab = new JLabel("<HTML><CENTER>"+
			...
			"Simulator<BR>"+
			"$Revision: 1.36 $ $Date: 2012/01/29 15:46:12 $<BR>"+
			"<BR>"+
			"<IMG SRC=\"file:icons/wang700.gif\">"+
			"<BR>"+
			"Developed by Douglas Miller<BR>"+
			"http://www.durgadas.com/wang700.html<BR>"+
			"<BR>"+
			"With Rick Bensene<BR>"+
			"http://http://www.oldcalculatormuseum.com/wang720.html<BR>"+
			"</CENTER></HTML>");
