...
#define ADD_Y(longreg)		_oplongreg(ADD_Y,longreg)
#define SUB_Y(longreg)		_oplongreg(SUB_Y,longreg)
#define MULT_Y(longreg)		_oplongreg(MULT_Y,longreg)
#define DIV_Y(longreg)		_oplongreg(DIV_Y,longreg)
#define ST_Y(longreg)		_oplongreg(ST_Y,longreg)
#define RE_Y(longreg)		_oplongreg(RE_Y,longreg)
#define EXCHG_Y(longreg)	_oplongreg(EXCHG_Y,longreg)
...
#define ADD_IND(longreg)	_oplongreg(ADD_IND,longreg)
#define SUB_IND(longreg)	_oplongreg(SUB_IND,longreg)
#define MULT_IND(longreg)	_oplongreg(MULT_IND,longreg)
#define DIV_IND(longreg)	_oplongreg(DIV_IND,longreg)
#define ST_IND(longreg)		_oplongreg(ST_IND,longreg)
#define RE_IND(longreg)		_oplongreg(RE_IND,longreg)
#define EXCHG_IND(longreg)	_oplongreg(EXCHG_IND,longreg)
