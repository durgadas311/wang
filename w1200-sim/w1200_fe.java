...
// $Id: w1200_fe.java,v 1.72 2013/12/05 22:31:57 drmiller Exp $
...
{
	final String ident = "$Id: w1200_fe.java,v 1.72 2013/12/05 22:31:57 drmiller Exp $";
	...
	implements Wang_Help, ActionListener, WindowListener, ComponentListener, HyperlinkListener
{
	...
	public void showAbout() {
		...
		JLabel lab = new JLabel("<HTML><CENTER>"+
			...
			"Simulator<BR>"+
			"$Revision: 1.72 $ $Date: 2013/12/05 22:31:57 $<BR>"+
			"<BR>"+
	...
	implements ActionListener, KeyListener, WindowListener, ComponentListener
{
	...
	private void do_button(boolean alt, boolean coded, int y, int x) {
		...
		if (type == Wang_Keys.ALT) {
			...
			code = Wang_UI.getCharConv().tiltrotateToCodedTiltrotate((byte)code, _code);
		}
...
//		add(pan);
	...
	private void process_keychar(char c, boolean coded) {
		...
		int i= Wang_UI.getCharConv().asciiToCodedTiltrotate((byte)c, _code);
		if (!coded) setCode(false);
