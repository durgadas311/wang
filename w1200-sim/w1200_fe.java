...
// $Id: w1200_fe.java,v 1.57 2012/01/29 16:29:02 drmiller Exp $
...
class _Key {
	final String ident = "$Id: w1200_fe.java,v 1.57 2012/01/29 16:29:02 drmiller Exp $";
	...
	implements ActionListener, WindowListener, ComponentListener, HyperlinkListener
{
	...
	public void showAbout() {
		...
		JLabel lab = new JLabel("<HTML><CENTER>"+
			...
			"Simulator<BR>"+
			"$Revision: 1.57 $ $Date: 2012/01/29 16:29:02 $<BR>"+
			"<BR>"+
			"<IMG SRC=\""+url.toString()+"\">"+
			"<BR>"+
			"Developed by Douglas Miller<BR>"+
			"http://www.durgadas.com/wang1200.html<BR>"+
			"<BR>"+
			"With Jim Battle<BR>"+
